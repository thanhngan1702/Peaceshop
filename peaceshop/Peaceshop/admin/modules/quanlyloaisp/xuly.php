...
class xulyLoaiSP extends DB {
    ...
    public function themLoaiSP() {
        if (@$_POST) {
            ...
            if (@$this->querry($sql)) {
                header('location:../../index.php?quanly=loaisp&ac=lietke&tt=<div class="alert alert-success"><strong>Thêm!</strong> Đã thêm nhóm sản phẩm mới thành công.</div>');
            } else {
    ...
    public function suaLoaiSP() {
        if (isset($_GET['id'])) {
            ...
            if (@$_POST) {
                ...
                if (@$this->querry($sql)) {
                    header('location:../../index.php?quanly=loaisp&ac=lietke&tt=<div class="alert alert-success"><strong>Sửa!</strong> Đã lưu nhóm sản phẩm ' . $tenloaisp . ' thành công.</div>');
                } else {
                    header('location:../../index.php?quanly=loaisp&ac=lietke&tt=<div class="alert alert-danger"><strong>Lỗi!</strong> Đã xảy ra vấn đề. Vui long thử lại sau.</div>');
                }
            } else {
    ...
    public function xoaLoaiSP() {
        if (isset($_GET['id'])) {
            ...
            if (@$this->querry($sql)) {
                header('location:../../index.php?quanly=loaisp&ac=lietke&tt=<div class="alert alert-success"><strong>Xóa!</strong> Đã xóa nhóm sản phẩm ' . $id . ' thành công.</div>');
            } else {
                header('location:../../index.php?quanly=loaisp&ac=lietke&tt=<div class="alert alert-danger"><strong>Lỗi!</strong> Đã xảy ra vấn đề. Vui long thử lại sau.</div>');
            }
        } else {
